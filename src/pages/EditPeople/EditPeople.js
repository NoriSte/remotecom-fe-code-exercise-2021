  ...
  useEffect(() => {
   setIsSubmitting(true);
    getPerson(id).then((res) => {
       const { name, jobTitle, country, salary, employment, currency } = res;
       handleChange(setName, 'name', name);
       handleChange(setJobTitle, 'jobTitle', jobTitle);
       handleChange(setCountry, 'country', country);
       handleChange(setSalary, 'salary', salary);
       handleChange(setCurrency, 'currency', currency);
       handleChange(setEmployment, 'employment', employment);
    ...
    <Container>
      <Card>
        ...
        <CardFooter>
          ...
          <Button type="submit" form="AddForm" bigger>
            Save
          </Button>
        </CardFooter>
      </Card>
